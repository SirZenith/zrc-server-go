CREATE USER ARCAEA IDENTIFIED BY ARCAEA;
...
CREATE TABLE BEST_30 ( 
	USER_ID              number(9)  NOT NULL,
	PLAYED_DATE          number(10)  NOT NULL,
	CONSTRAINT IDX_BEST_30 PRIMARY KEY ( USER_ID, PLAYED_DATE ) 
 );
...
CREATE TABLE DATA_BACK_UP ( 
	USER_ID              number(9)  NOT NULL,
	DEVICE_ID            varchar2(20)  NOT NULL,
	DATA                 raw(2000)  NOT NULL,
...
CREATE TABLE RECENT_10 ( 
	USER_ID              number(9)  NOT NULL,
	PLAYED_DATE          number(10)  NOT NULL,
	CONSTRAINT IDX_RECENT_10 PRIMARY KEY ( USER_ID, PLAYED_DATE ) 
 );
...
ALTER TABLE BEST_30 ADD CONSTRAINT FK_BEST_30_BEST_SCORE FOREIGN KEY ( USER_ID, PLAYED_DATE ) REFERENCES BEST_SCORE( USER_ID, PLAYED_DATE );
...
ALTER TABLE BEST_SCORE ADD CONSTRAINT FK_BEST_SCORE_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SONG( SONG_ID );
...
ALTER TABLE DATA_BACK_UP ADD CONSTRAINT FK_DATA_BACK_UP_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID );
...
ALTER TABLE RECENT_10 ADD CONSTRAINT FK_RECENT_10_RECENT_PLAYED FOREIGN KEY ( USER_ID, PLAYED_DATE ) REFERENCES RECENT_PLAYED( USER_ID, PLAYED_DATE );

ALTER TABLE RECENT_PLAYED ADD CONSTRAINT FK_RECENT_PLAYED_SCORE FOREIGN KEY ( USER_ID, PLAYED_DATE ) REFERENCES SCORE( USER_ID, PLAYED_DATE );
