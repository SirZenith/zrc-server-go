...
CREATE TABLE MAP_AFFINITY ( 
	...
	CONSTRAINT FK_MAP_AFFINITY_WORLD_MAP FOREIGN KEY ( MAP_ID ) REFERENCES WORLD_MAP( MAP_ID ) ,
	CONSTRAINT FK_MAP_AFFINITY_PARTNER FOREIGN KEY ( PART_ID ) REFERENCES PARTNER( PART_ID )
 );
...
CREATE TABLE MAP_REWARD ( 
	...
	CONSTRAINT FK_MAP_REWARD_WORLD_MAP FOREIGN KEY ( MAP_ID ) REFERENCES WORLD_MAP( MAP_ID )
 );
...
CREATE TABLE PLAYER ( 
	...
	CONSTRAINT FK_USER_WORLD_MAP FOREIGN KEY ( CURR_MAP ) REFERENCES WORLD_MAP( MAP_ID ),
	CONSTRAINT FK_PLAYER_CHARACTER FOREIGN KEY ( PARTNER ) REFERENCES PARTNER( PART_ID )
	-- CONSTRAINT FK_PLAYER_SCORE FOREIGN KEY ( RECENT_SCORE_DATE ) REFERENCES SCORE( PLAYED_DATE )
 );
 ...
 CREATE TABLE FRIEND_LIST ( 
	...
	CONSTRAINT FK_FRIEND_LIST_PARTNER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID ),
	CONSTRAINT FK_FRIEND_LIST_PLAYER FOREIGN KEY ( FRIEND_ID ) REFERENCES PLAYER( USER_ID )
 );
 ...
 CREATE TABLE PLAYER_MAP_PROG ( 
	...
	IS_LOCKED            char(1),
	CONSTRAINT FK_PLAYER_MAP_PROG_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID ),
	CONSTRAINT FK_PLAYER_MAP_PROG_WORLD_MAP FOREIGN KEY ( MAP_ID ) REFERENCES WORLD_MAP( MAP_ID )
 );
 ...
 CREATE TABLE DATA_BACKUP ( 
	...
	CONSTRAINT FK_DATA_BACK_UP_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
...
CREATE TABLE PACK_ITEM ( 
	...
	CONSTRAINT FK_PACK_ITEM_PACK FOREIGN KEY ( PACK_NAME ) REFERENCES PACK( PACK_NAME ),
	CONSTRAINT FK_PACK_POESS_INFO_PACKS FOREIGN KEY ( PACK_NAME ) REFERENCES PACK( PACK_NAME )
 );

CREATE TABLE PACK_PURCHASE_INFO ( 
	USER_ID              number(9)  NOT NULL,
	PACK_NAME            varchar2(30)  NOT NULL,
	CONSTRAINT FK_PACK_POESS_INFO_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
 ...
 CREATE TABLE SONG ( 
	...
	CONSTRAINT FK_SONG_PACKS FOREIGN KEY ( PACK_NAME ) REFERENCES PACK( PACK_NAME )
 );
...
CREATE TABLE CHART_INFO ( 
	...
	CONSTRAINT FK_CHART_INFO_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SONG( SONG_ID ) 
 );

CREATE TABLE SINGLE ( 
	SONG_ID              varchar2(30)  NOT NULL,
	CONSTRAINT PK_SINGLES_SONG_ID PRIMARY KEY ( SONG_ID ) ,
	CONSTRAINT FK_SINGLES_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SONG( SONG_ID )
 );
 
 CREATE TABLE SINGLE_PURCHASE_INFO ( 
	USER_ID              number(9)  NOT NULL,
	SONG_ID              varchar2(30)  NOT NULL,
	CONSTRAINT FK_SINGLE_POESS_INFO_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID ),
	CONSTRAINT FK_SINGLE_POESS_INFO_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SINGLE( SONG_ID )
 );
...
CREATE TABLE PART_STATS ( 
	...
	CONSTRAINT FK_PART_POSS_INFO_PARTNER FOREIGN KEY ( PART_ID ) REFERENCES PARTNER( PART_ID ),
	CONSTRAINT FK_PART_POSS_INFO_USER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID ),
	CONSTRAINT FK_CHAR_STATUS_LEVEL_EXP FOREIGN KEY ( LV ) REFERENCES LEVEL_EXP( LV )
 );
...
CREATE TABLE CORE_POSSESS_INFO ( 
	...
	CONSTRAINT FK_CORE_POESS_INFO_CORES FOREIGN KEY ( CORE_ID ) REFERENCES CORE( CORE_ID ),
	CONSTRAINT FK_CORE_POESS_INFO_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
...
CREATE TABLE WORLD_UNLOCK ( 
	USER_ID              number(9)  NOT NULL,
	ITEM_NAME            varchar2(30)  NOT NULL,
	CONSTRAINT FK_WORLD_ITEM_POESS_INFO FOREIGN KEY ( ITEM_NAME ) REFERENCES WORLD_ITEM( ITEM_NAME ),
	CONSTRAINT FK_USER_ID FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
...
CREATE TABLE WORLD_SONG_UNLOCK ( 
	...
	CONSTRAINT FK_WORLD_SONG_UNLOCK FOREIGN KEY ( ITEM_NAME ) REFERENCES WORLD_SONG( ITEM_NAME ),
	CONSTRAINT FK_WORLD_SONG_UNLOCK_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
 ...
 CREATE TABLE SCORE ( 
	...
	CONSTRAINT FK_PLAY_RECORD_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SONG( SONG_ID ),
	CONSTRAINT FK_PLAY_RECORD_USER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
...
CREATE TABLE BEST_SCORE ( 
	...
	CONSTRAINT FK_BEST_SCORE_SCORE FOREIGN KEY ( USER_ID, PLAYED_DATE ) REFERENCES SCORE( USER_ID, PLAYED_DATE )
 );
...
CREATE TABLE RECENT_SCORE ( 
	...
	CONSTRAINT FK_RECENT_PLAYED_SCORE FOREIGN KEY ( USER_ID, PLAYED_DATE ) REFERENCES SCORE( USER_ID, PLAYED_DATE )
 );
...
CREATE TABLE DL_REQUEST ( 
	...
	CONSTRAINT FK_DL_REQUEST_SONG FOREIGN KEY ( SONG_ID ) REFERENCES SONG( SONG_ID ),
	CONSTRAINT FK_DL_REQUEST_PLAYER FOREIGN KEY ( USER_ID ) REFERENCES PLAYER( USER_ID )
 );
